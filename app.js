...
function bookingIsFinanciallyExcluded(b){
  ...
  return !b||b.financialExcluded===true||b.deleted===true||!!b.cancelledAt||!!b.canceledAt||!!b.cancelledBy||!!b.canceledBy||status==="cancelled"||status==="canceled"||status==="deleted"||status==="rescheduled";
}
